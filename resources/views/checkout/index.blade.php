                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="billing-details pr-10">
                                                        ...
                                                        <input style="font-size: 22px !important;" type="text" name="ten"  placeholder="Tên của bạn...">
                                                        <input style="font-size: 22px !important;    height: 45px;" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" placeholder="Email của bạn...">
                                                        <input style="font-size: 22px !important;margin-top: 20px;" type="text" name="sdt" placeholder="Số điện thoại...">
                                                        <input style="font-size: 22px !important;" type="text" name="diachi" placeholder="Địa chỉ...">
