                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                       ...
                       @foreach($data1 as $row1)
                        ...
                        @endforeach
                           <!-- <label onclick="check('{{$da->id}}','{{$da->masery}}','{{$da->Mancc}}','{{$da->name}}','{{$da->price}}')">check</label> -->
                         ...
                         <label style="margin-left: 100px">Tên sản phẩm</label>
                          ...
                          <input onclick="ThemAdd('{{$da->id}}','{{$da->masery}}','{{$da->Mancc}}','{{$da->name}}','{{$da->price}}','{{$row1->Ten}}')" type="submit" value="Thêm" style="color: white;background-color:#24315f ">
                           </div>
       ...
       <script>
           function ThemAdd(id,sery,mancc,tensp,gia,tenncc) {
